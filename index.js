...
const descriptionText = `A total of $${GAMES_JSON.reduce((acc, game) => acc + game.pledged, 0).toLocaleString()} has been raised across ${GAMES_JSON.length} games. 
Currently, ${unfundedGamesCount} game${unfundedGamesCount === 1 ? "" : "s"} remain unfunded. We need your help to fund more amazing games!`
...
// grab the search input element and listen for input events
const searchInput = document.createElement("input");
searchInput.setAttribute("type", "text");
searchInput.setAttribute("id", "search-bar");
searchInput.setAttribute("placeholder", "Search for a game...");
document.body.insertBefore(searchInput, gamesContainer);
